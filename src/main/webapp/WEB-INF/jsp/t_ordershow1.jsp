        ...
        <%
            ...
            for (int i=0;i<goods.size();i++){
                ...
                switch (i){
                    ...
                    case 9:
                    case 1:
                        out.println("<td align=center>"+"<button onclick=\"add5()\" class=\"layui-btn layui-btn-sm layui-btn-danger\">更新修改</a>"+"</td");
                        break;
                }
...
<form action="/buyer/update" class="col-md-3" id="create_table_from"  method="post" lay-filter="create_table_from" style="display: none;">
    I&emsp;D&emsp;:<input type="text" name="id"><br>
    数&emsp;量:<input type="text" name="amount"><br>
    <center><input type="submit" name="submit" class="btn btn-info" value="修改" onclick="success11()"><br></center></form>
</body>
</html>
